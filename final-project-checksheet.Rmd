...
(A) .Rmd Line numbers where at least two different data sources are imported:  **81-85**


(B) .Rmd Line numbers for inspecting data intake: **87-116**
...
(A) .Rmd Line number(s) for general data wrangling: **157-182**


(B) .Rmd Line number(s) for a join operation: **159**


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent):  **157-182** (This was done manually, please read block of text preceding code chunk)


(D) .Rmd Line number(s) for use of regular expressions: **131-137**


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: **106, 109**
...
(A) .Rmd Line number(s) for use of multiple different geoms: **171-179**

(B) .Rmd Line number(s) for use of multiple aesthetics: **171-179**

(C) .Rmd Line number(s) for use of layered graphics: **177, 189**
